...
$ConsoleDest = Join-Path $RepoRoot "src\jotaduo\console"
...
Write-Host "[wheel_build] Copying console/dist/* -> src/jotaduo/console/..."
...
$DocsDest = Join-Path $RepoRoot "src\jotaduo\docs"
