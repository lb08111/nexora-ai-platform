...
class TestAddFileHandler:
    ...
    def test_creates_log_directory(self, tmp_path):
        ...
        log_path = tmp_path / "logs" / "jotaduo.log"
...
class TestLogConstants:
    ...
    def test_log_namespace_is_jotaduo(self):
        """S级: LOG_NAMESPACE is 'jotaduo'."""
        assert LOG_NAMESPACE == "jotaduo"
