...
def _ensure_alias():
    target = _PLUGIN_PARENT / "jotaduo-team"
    if not target.exists():
        return
    if "jotaduo_team_plugin" in sys.modules:
        return
    ...
    sys.modules["jotaduo_team_plugin"] = module
...
def _reset_store():
    from jotaduo_team_plugin.store import get_meeting_store  # noqa: E402
