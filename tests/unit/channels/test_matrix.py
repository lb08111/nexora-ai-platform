...
from jotaduo.app.channels.matrix.channel import MatrixChannel
from jotaduo.config.config import MatrixConfig
...
class TestMatrixChannelStartStop:
    ...
    async def test_start_creates_client(
        ...
        with patch(
            "jotaduo.app.channels.matrix.channel.JotaDuoMatrixClient",
