# -*- coding: utf-8 -*-
"""Tests for jotaduo.security.skill_scanner.analyzers.pattern_analyzer.
...
from jotaduo.security.skill_scanner.analyzers.pattern_analyzer import (
    PatternAnalyzer,
    RuleLoader,
    SecurityRule,
)
...
from jotaduo.security.skill_scanner.scan_policy import (
    CredentialPolicy,
    ScanPolicy,
)
