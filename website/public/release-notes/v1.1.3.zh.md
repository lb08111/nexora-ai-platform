...
- **ACP Server**：通过 `jotaduo acp` 将 JotaDuo Agent 以 ACP（Agent Communication Protocol）协议对外暴露为标准端点 ([#3487](https://github.com/agentscope-ai/QwenPaw/pull/3487), [#3589](https://github.com/agentscope-ai/QwenPaw/pull/3589), [#3595](https://github.com/agentscope-ai/QwenPaw/pull/3595))
...
- **更新供应商 Base URL**：`jotaduo providers update` 命令现支持通过命令行更新供应商的 Base URL ([#3536](https://github.com/agentscope-ai/QwenPaw/pull/3536))
