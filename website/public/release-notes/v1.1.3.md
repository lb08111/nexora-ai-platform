...
- **ACP Server**: Expose JotaDuo agents as ACP (Agent Communication Protocol) endpoints over stdio via `jotaduo acp` ([#3487](https://github.com/agentscope-ai/QwenPaw/pull/3487), [#3589](https://github.com/agentscope-ai/QwenPaw/pull/3589), [#3595](https://github.com/agentscope-ai/QwenPaw/pull/3595))
...
- **Update Provider Base URLs**: `jotaduo providers update` now supports updating provider base URLs from the command line ([#3536](https://github.com/agentscope-ai/QwenPaw/pull/3536))
