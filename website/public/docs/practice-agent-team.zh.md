# JotaDuo Agent Team 实践指南

本文档介绍如何使用 JotaDuo + HiClaw 构建多智能体协作团队，实现从单一 Agent 到 Agent Team 的能力跃迁。
...
JotaDuo Team 通过组合 **JotaDuo** + **[HiClaw](https://hiclaw.io/)**，提供完整的多 Agent 编排协作方案：

- **JotaDuo Team Leader**：基于 JotaDuo 构建，担任团队协调者，负责任务分解、工作分配和结果汇总
- **JotaDuo Workers**：基于 JotaDuo 构建，担任任务执行者，专注于特定领域工作，接收 Leader 指令并返回结果
...
- [JotaDuo 快速开始](./quickstart)
- [JotaDuo 多智能体](./multi-agent)
...
JotaDuo Agent Team 通过 JotaDuo 和 HiClaw 的结合，为个人开发者和小型团队提供了强大的多智能体协作能力。通过合理的团队设计和任务分配，可以显著提升工作效率，实现"一个人的团队"。
