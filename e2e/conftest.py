# -*- coding: utf-8 -*-
"""
JotaDuo E2E Test Framework - Pytest Configuration
"""
...
# This ensures JOTADUO_HEADLESS correctly controls the browser display mode.
pytest_plugins = []
...
def pytest_collection_modifyitems(config, items):
    ...
    if os.getenv("JOTADUO_DASHSCOPE_API_KEY"):
        return
    skip_llm = pytest.mark.skip(reason="JOTADUO_DASHSCOPE_API_KEY not set — LLM tests skipped")
    for item in items:
...
def pytest_configure(config):
    ...
    metadata['Project'] = 'JotaDuo E2E Automation'
...
def pytest_html_report_title(report):
    ...
    try:
        report.title = "JotaDuo E2E Automation Test Report"
    except Exception:
        pass
...
def pytest_html_results_summary(prefix, summary, postfix):
    ...
    prefix.extend([
        "<p>This report is auto-generated by the JotaDuo E2E automation framework.</p>",
