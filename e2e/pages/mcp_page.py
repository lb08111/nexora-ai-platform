...
class McpPage(BasePage):
    ...
    CREATE_BTN_SELECTOR = 'button.jotaduo-btn-primary:has-text("创建客户端")'
    ...
    # Create dialog
    MODAL_CONTENT_SELECTOR = '.jotaduo-modal-content'
    MODAL_TITLE_SELECTOR = '.jotaduo-spark-modal-title'
