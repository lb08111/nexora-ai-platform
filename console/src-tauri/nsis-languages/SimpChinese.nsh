...
LangString jotaduoCliPathPageTitle ${LANG_SIMPCHINESE} "命令行"
LangString jotaduoCliPathPageSubtitle ${LANG_SIMPCHINESE} "选择是否让终端可以直接使用 jotaduo。"
LangString jotaduoCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 jotaduo 命令加入你的用户 PATH。之后可通过重新安装或卸载 JotaDuo Desktop 变更。"
LangString jotaduoCliPathCheckbox ${LANG_SIMPCHINESE} "将 jotaduo 添加到 PATH"
LangString jotaduoCliPathAdded ${LANG_SIMPCHINESE} "已将 jotaduo 添加到用户 PATH"
LangString jotaduoCliPathSkipped ${LANG_SIMPCHINESE} "已跳过添加 jotaduo 到用户 PATH"
LangString jotaduoCliPathMissing ${LANG_SIMPCHINESE} "未找到 jotaduo.exe，已跳过 PATH 更新"
LangString jotaduoCliPathUpdateFailed ${LANG_SIMPCHINESE} "更新用户 PATH 失败"
