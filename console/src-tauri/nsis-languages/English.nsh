...
LangString jotaduoCliPathPageTitle ${LANG_ENGLISH} "Command line"
LangString jotaduoCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether jotaduo is available in terminals."
LangString jotaduoCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled jotaduo command to your user PATH. You can change it later by reinstalling or uninstalling JotaDuo Desktop."
LangString jotaduoCliPathCheckbox ${LANG_ENGLISH} "Add jotaduo to PATH"
LangString jotaduoCliPathAdded ${LANG_ENGLISH} "Added jotaduo to user PATH"
LangString jotaduoCliPathSkipped ${LANG_ENGLISH} "Skipped adding jotaduo to user PATH"
LangString jotaduoCliPathMissing ${LANG_ENGLISH} "jotaduo.exe was not found; skipped PATH update"
LangString jotaduoCliPathUpdateFailed ${LANG_ENGLISH} "Failed to update user PATH"
