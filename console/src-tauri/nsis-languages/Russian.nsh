...
LangString jotaduoCliPathPageTitle ${LANG_RUSSIAN} "Command line"
LangString jotaduoCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether jotaduo is available in terminals."
LangString jotaduoCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled jotaduo command to your user PATH. You can change it later by reinstalling or uninstalling JotaDuo Desktop."
LangString jotaduoCliPathCheckbox ${LANG_RUSSIAN} "Add jotaduo to PATH"
LangString jotaduoCliPathAdded ${LANG_RUSSIAN} "Added jotaduo to user PATH"
LangString jotaduoCliPathSkipped ${LANG_RUSSIAN} "Skipped adding jotaduo to user PATH"
LangString jotaduoCliPathMissing ${LANG_RUSSIAN} "jotaduo.exe was not found; skipped PATH update"
LangString jotaduoCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
