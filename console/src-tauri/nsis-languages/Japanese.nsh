...
LangString jotaduoCliPathPageTitle ${LANG_JAPANESE} "Command line"
LangString jotaduoCliPathPageSubtitle ${LANG_JAPANESE} "Choose whether jotaduo is available in terminals."
LangString jotaduoCliPathPageDescription ${LANG_JAPANESE} "This adds the bundled jotaduo command to your user PATH. You can change it later by reinstalling or uninstalling JotaDuo Desktop."
LangString jotaduoCliPathCheckbox ${LANG_JAPANESE} "Add jotaduo to PATH"
LangString jotaduoCliPathAdded ${LANG_JAPANESE} "Added jotaduo to user PATH"
LangString jotaduoCliPathSkipped ${LANG_JAPANESE} "Skipped adding jotaduo to user PATH"
LangString jotaduoCliPathMissing ${LANG_JAPANESE} "jotaduo.exe was not found; skipped PATH update"
LangString jotaduoCliPathUpdateFailed ${LANG_JAPANESE} "Failed to update user PATH"
