...
LangString jotaduoCliPathPageTitle ${LANG_PORTUGUESEBR} "Command line"
LangString jotaduoCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether jotaduo is available in terminals."
LangString jotaduoCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled jotaduo command to your user PATH. You can change it later by reinstalling or uninstalling JotaDuo Desktop."
LangString jotaduoCliPathCheckbox ${LANG_PORTUGUESEBR} "Add jotaduo to PATH"
LangString jotaduoCliPathAdded ${LANG_PORTUGUESEBR} "Added jotaduo to user PATH"
LangString jotaduoCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding jotaduo to user PATH"
LangString jotaduoCliPathMissing ${LANG_PORTUGUESEBR} "jotaduo.exe was not found; skipped PATH update"
LangString jotaduoCliPathUpdateFailed ${LANG_PORTUGUESEBR} "Failed to update user PATH"
