...
// Attach window.JotaDuo.chat (Chat customization), extend
// window.JotaDuo.host with hooks + fetch, attach window.JotaDuo.audit.
installHostSdk();
...
// the registry so `window.JotaDuo.modules.<page>` is populated soon after
