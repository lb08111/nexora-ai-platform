/**
 * plugins/types/jotaduo.d.ts — stable public contract for plugin authors.
 *
 * Plugin TS projects (cloudpaw, jotaduo-pet, …) should COPY this file into
 * their own `jotaduo-host.d.ts` and uncomment the `declare global` block at
 ...
 *
 * Inside the host, the global `Window.JotaDuo` is declared in
...
export interface JotaDuoChatNamespace {
  welcome: {
    set(
      pluginId: string,
      partial: Partial<{
...
export interface JotaDuoHostNamespace {
...
export interface JotaDuoAuditNamespace {
...
export interface JotaDuoWindowNamespace {
  host: JotaDuoHostNamespace;
...
// Plugin projects: uncomment this in your own jotaduo-host.d.ts to type
// `window.JotaDuo.*` accesses in plugin code.
//
// declare global {
//   interface Window {
//     JotaDuo: JotaDuoWindowNamespace;
//   }
// }
