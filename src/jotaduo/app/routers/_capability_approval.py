...
def capability_create_requires_approval(
    ...
    from jotaduo_ext.jotaduo.governance import get_approval_policy
...
def submit_capability_approval(
    ...
    *,
    ...
    from jotaduo_ext.jotaduo.approval_requests import create_approval_request
...
def record_auto_approved(
    ...
    *,
    ...
    from jotaduo_ext.jotaduo.approval_requests import update_approval_request
