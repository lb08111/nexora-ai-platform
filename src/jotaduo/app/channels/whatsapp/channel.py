...
try:
    ...
    NewAClient = None
    logger.warning(
        "neonize-jotaduo not installed. WhatsApp channel unavailable. "
        "Install: pip install jotaduo[whatsapp] "
        "(or explicitly: pip install neonize-jotaduo)",
    )
...
class WhatsAppChannel(BaseChannel):
    ...
    async def _stream_with_tracker(self, payload):
        """Override base to handle JotaDuo event format for WhatsApp."""
