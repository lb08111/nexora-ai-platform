...
from ...agents.react_agent import JotaDuoAgent
    ...
    def agent_name(self) -> str:
        ...
        if self._agent_name is None:
            try:
                ...
                self._agent_name = cfg.name if cfg and cfg.name else "JotaDuo"
            except Exception:
                self._agent_name = "JotaDuo"
        ...
        **kwargs,
        ...
        try:
            ...
            if _fork_project:
                ...
                _allowed_base = _project_base / ".jotaduo" / "worktrees"
                try:
