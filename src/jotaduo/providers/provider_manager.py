...
PROVIDER_JOTADUO = OpenAIProvider(
    id="jotaduo-local",
    name="JotaDuo Local",
    is_local=True,
...
class ProviderManager:  # pylint: disable=too-many-public-methods
    ...
    def _init_builtins(self):
        self._add_builtin(PROVIDER_JOTADUO)
    ...
    def _normalize_provider_id(provider_id: str) -> str:
        ...
        Maps legacy 'copaw-local' to 'jotaduo-local'.
        """
        if provider_id == "copaw-local":
            return "jotaduo-local"
        return provider_id
    ...
    def start_local_model_resume(self, local_manager) -> None:
        ...
        task = asyncio.create_task(
            ...
            name="jotaduo-local-model-resume",
        )
    ...
    def _migrate_copaw_config(self) -> None:
        ...
        try:
            ...
            provider = self.builtin_providers.get("jotaduo-local")
            if not provider:
                return
            ...
            logger.info(
                ...
                "'copaw-local.json' to 'jotaduo-local.json'",
            )
            ...
            if active_model:
                try:
                    ...
                    if active_model.get("provider_id") == "copaw-local":
                        active_model["provider_id"] = "jotaduo-local"
    ...
    def _init_from_storage(self):
        ...
        # Migrate copaw-local to jotaduo-local for backwards compatibility
    ...
    async def _resume_local_model(self, local_manager) -> None:
        ...
        local_models = self.get_provider("jotaduo-local").extra_models
