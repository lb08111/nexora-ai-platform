# -*- coding: utf-8 -*-
"""Tool-guard mixin for JotaDuoAgent.
...
if TYPE_CHECKING:
    from jotaduo.app.approvals import PendingApproval
...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from jotaduo.security.tool_guard.engine import get_guard_engine
        from jotaduo.app.approvals import get_approval_service
    ...
    async def _decide_guard_action(
        ...
        from jotaduo.security.tool_guard.utils import log_findings
    ...
    async def _acting_auto_denied(
        ...
        from jotaduo.security.tool_guard.approval import (
