# -*- coding: utf-8 -*-
"""Coding Mode mixin for JotaDuoAgent.
...
The internal JotaDuo workspace (configs, sessions, memory) is at:
...
class CodingModeMixin:
    ...
    At runtime this class is mixed into ``JotaDuoAgent`` and combined
    ...
    # ------------------------------------------------------------------
    # Tool registration hook (called from JotaDuoAgent._create_toolkit)
    # ------------------------------------------------------------------
