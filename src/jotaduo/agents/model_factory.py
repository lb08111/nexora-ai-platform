...
Example:
    >>> from jotaduo.agents.model_factory import create_model_and_formatter
...
def _normalize_messages_for_formatter(
    ...
    if getattr(formatter_instance, "_jotaduo_force_strip_media", False):
        ...
        if not global_model:
            raise ProviderError(
                message=(
                    ...
                    "Please configure a model using 'jotaduo models config' "
