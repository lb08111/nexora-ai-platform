...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs JotaDuo (e.g. "
...
async def stop_browsers_for_workspace_dirs(
    ...
    directories. It releases JotaDuo-owned Playwright/Chromium handles without
...
async def browser_use(  # pylint: disable=R0911,R0912
    ...
    Args:
        ...
        cdp_port (int):
            ...
            JotaDuo chooses a free local port automatically for managed CDP.
        private_mode (bool):
            ...
            via CDP. Default False. By default, JotaDuo prefers managed CDP for
