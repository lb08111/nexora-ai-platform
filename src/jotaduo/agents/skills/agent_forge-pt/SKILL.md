...
description: |
  ...
  agente, time de agentes, skill ou plugin para o JotaDuo / Jotaduo.
...
| `scaffold_skill(name, description, when_to_use, emoji, body_markdown)` | 1 SKILL.md | `src/jotaduo/agents/skills/<kebab>/` |
| `scaffold_agent(name, role, description, system_prompt)` | 1 módulo Python | `src/jotaduo/agents/<snake>_agent.py` |
| `scaffold_team(name, roles, default_prompt_prefix)` | pacote 5 arquivos | `src/jotaduo/agents/<snake>/` |
