# -*- coding: utf-8 -*-
"""JotaduoOrchestrator: líder do time BR.

Usa as tools NATIVAS de coordenação inter-agente já existentes em
``jotaduo.agents.tools.agent_management`` (``list_agents``,
...
como o padrão Hub-and-Spoke do jotaduo. Isso permite que cada
...
class JotaduoOrchestrator(ReActAgent):
    ...
    def __init__(
        ...
        logger.info(
            "JotaduoOrchestrator pronto (name=%s, tools=%d)",
            name,
            len(tools),
        )
