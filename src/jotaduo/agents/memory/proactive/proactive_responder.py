...
async def send_proactive_message_via_http(
    ...
    """Send a proactive message by directly calling the JotaDuo API."""
    ...
    try:
        ...
        logger.error(
            "Timeout (%ds) calling JotaDuo API for proactive message",
            timeout_seconds,
        )
    except Exception as e:
        logger.error("Error calling JotaDuo API for proactive message: %s", e)
