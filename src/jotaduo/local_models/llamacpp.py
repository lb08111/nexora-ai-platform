...
class LlamaCppBackend:
    """
    JotaDuo local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"jotaduo-llamacpp-download-{staging_dir.name}",
            command=["jotaduo-llamacpp-download", download_url],
