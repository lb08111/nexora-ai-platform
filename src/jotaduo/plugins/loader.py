...
class PluginLoader:
    ...
    def _install_requirements(
        ...
        the case for uv-managed venvs created by the JotaDuo script
    ...
    async def unload_plugin(
        ...
        removes the plugin's tools from ``jotaduo.agents.tools``.
    ...
    def _cleanup_plugin_tools(
        ...
        """Remove plugin tools from ``jotaduo.agents.tools``.
        ...
        """
        try:
            tools_module = sys.modules.get("jotaduo.agents.tools")
