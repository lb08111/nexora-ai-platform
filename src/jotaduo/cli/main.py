...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("jotaduo.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("jotaduo.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "jotaduo.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("jotaduo.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("jotaduo.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("jotaduo.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("jotaduo.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("jotaduo.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("jotaduo.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("jotaduo.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "jotaduo.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("jotaduo.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "jotaduo.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("jotaduo.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("jotaduo.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "jotaduo.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("jotaduo.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("jotaduo.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("jotaduo.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "jotaduo.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("jotaduo.cli.task_cmd", "task_cmd", ".task_cmd"),
        "doctor": ("jotaduo.cli.doctor_cmd", "doctor_cmd", ".doctor_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="JotaDuo")
