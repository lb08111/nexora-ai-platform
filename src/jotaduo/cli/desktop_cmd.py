# -*- coding: utf-8 -*-
"""CLI command: run JotaDuo app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run JotaDuo app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing JotaDuo app instance.
    """
    ...
    click.echo(f"Starting JotaDuo app on {url} (port {port})")
