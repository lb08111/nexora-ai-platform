# -*- coding: utf-8 -*-
"""Scaffold a QwenPaw plugin bundle (manifest + entry class + router)."""
...
_PLUGIN_PY = '''\
# -*- coding: utf-8 -*-
"""{title} plugin for QwenPaw — gerado pelo AgentForge."""

from __future__ import annotations

import logging

logger = logging.getLogger("qwenpaw").getChild("plugin.{plugin_id}")
...
2. Reinicie o backend QwenPaw — o hook `{plugin_id_us}_init` roda
   automaticamente.
...
async def scaffold_plugin(
    ...
    """Generate a minimal QwenPaw plugin bundle.
    ...
    Args:
        ...
        min_version: Minimum QwenPaw version supported.
