# -*- coding: utf-8 -*-
"""GET /api/nexora-team/team — list registered Nexora specialists.

Also supports POST /api/nexora-team/team/build to materialize a
...
logger = logging.getLogger("qwenpaw").getChild(
    "plugin.nexora-team.routers.team",
)

router = APIRouter(prefix="", tags=["nexora-team"])
...
def list_team() -> TeamListResponse:
    """List the Nexora specialists this plugin registers."""
    agents = [
        AgentInfo(
