# -*- coding: utf-8 -*-
"""Shared constants and agent specs for the nexora-team plugin.

Reuses ``qwenpaw.agents.br_team`` (prompts + tools + factory) to register
five Brazilian specialist agents into the QwenPaw multi-agent manager.
"""
...
ORCHESTRATOR_AGENT_ID = "nexora-orchestrator"
ATENDENTE_AGENT_ID = "nexora-atendente"
AGENDAMENTO_AGENT_ID = "nexora-agendamento"
VENDAS_AGENT_ID = "nexora-vendas"
FINANCEIRO_AGENT_ID = "nexora-financeiro"
...
# selection inside ``qwenpaw.agents.br_team``.
...
_ORCHESTRATOR_EXTRA_TOOLS: dict[str, dict[str, Any]] = {
    "chat_with_agent": {
        ...
        "enabled": True,
        "description": "Envia mensagem para outro agente do time Nexora",
        "icon": "💬",
    },
    "submit_to_agent": {
    ...
    "list_agents": {
        "name": "list_agents",
        "enabled": True,
        "description": "Lista os especialistas Nexora disponíveis",
        "icon": "🔍",
    },
    "convene_meeting": {
...
AGENT_SPECS: list[dict[str, Any]] = [
    {
        ...
        "description": (
            "Maestro do time Nexora. Recebe mensagens dos clientes "
        ...
        "skill_names": ["br_orchestrator-pt", "nexora-meeting-pt"],
...
PLUGIN_SKILLS = ["nexora-meeting-pt"]
