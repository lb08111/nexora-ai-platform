/** JotaDuo console stores UI language in ``localStorage.language``. */

const LANGUAGE_KEY = "language";
const LANGUAGE_EVENT = "jotaduo-pet-language-change";
...
function installLanguageSetItemHook(): void {
  const marker = "__jotaduoPetLanguageHook";
...
/** Subscribe to JotaDuo header language switcher (no console changes needed). */
