/** Pet plugin UI locale — follows JotaDuo console ``localStorage.language``. */
...
const messages = {
  en: {
    ...
    title: "JotaDuo Pet",
    intro:
      "Installed pets live under your JotaDuo working directory. Start the desktop bridge, then switch the floating pet without restarting JotaDuo.",
  ...
  zh: {
    ...
    title: "JotaDuo 桌面宠物",
    intro:
      "已安装的宠物位于 JotaDuo 工作目录下。启动桌面桥接后，可在不重启 JotaDuo 的情况下切换悬浮宠物。",
    startDesktop: "启动桌面宠物",
    importPet: "导入宠物",
    refresh: "刷新",
    petsDirectory: "宠物目录：",
...
/** Map JotaDuo console language to pet UI locale (non zh/en → en). */
