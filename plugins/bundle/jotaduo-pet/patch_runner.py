# -*- coding: utf-8 -*-
"""Patch JotaDuo AgentRunner from inside the backend plugin."""
...
def _request_meta(runner: Any, request: Any) -> dict[str, Any]:
    return {
        ...
        "agent_name": getattr(runner, "agent_name", "JotaDuo"),
...
def patch_agent_runner() -> None:
    ...
    _PATCHED = True
    logger.info("JotaDuo Pet patched AgentRunner.query_handler")
...
def restore_agent_runner() -> None:
    ...
    _PATCHED = False
    logger.info("JotaDuo Pet restored AgentRunner.query_handler")
