# -*- coding: utf-8 -*-
"""Shared constants for the nexora-fiscal plugin."""
...
PLUGIN_ID = "nexora-fiscal"
FISCAL_AGENT_ID = "nexora-fiscal"
...
AGENT_SPEC: dict[str, Any] = {
    ...
    "name": "Nexora Fiscal",
    "description": (
        "Especialista Fiscal Nexora para emissão, consulta, cancelamento, "
