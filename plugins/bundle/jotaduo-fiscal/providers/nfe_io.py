...
class NFEioProvider(AbstractFiscalProvider):
    """Placeholder adapter for NFE.io fiscal APIs."""

    provider_name = "nfe_io"
    ...
    def _not_wired(
        ...
        return fiscal_response(
            ...
            "NFE.io provider is a scaffold stub and is not wired yet.",
        )
