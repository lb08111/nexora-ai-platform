...
class PagBankPixProvider(AbstractPixProvider):
    """Provider placeholder for a future PagBank integration."""
    ...
    def _not_implemented(self, operation: str, **extra: Any) -> dict[str, Any]:
        payload = {
            ...
            "message": "PagBank provider scaffold is not wired yet.",
        }
