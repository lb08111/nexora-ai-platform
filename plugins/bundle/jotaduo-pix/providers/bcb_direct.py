# -*- coding: utf-8 -*-
"""Banco Central PIX API direct provider stub."""
...
class BcbDirectPixProvider(AbstractPixProvider):
    """Provider placeholder for direct BCB Pix API connectivity."""
    ...
    def _not_implemented(self, operation: str, **extra: Any) -> dict[str, Any]:
        payload = {
            ...
            "message": "BCB direct provider scaffold requires mTLS setup.",
        }
